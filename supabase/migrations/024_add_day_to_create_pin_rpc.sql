...
GRANT EXECUTE ON FUNCTION public.create_pin(uuid, uuid, text, double precision, double precision, text, text, text, text, integer, integer, text) TO authenticated;
